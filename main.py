...
df , query , unique_tokens, word_map= dataset_generator.dataset_format_converter(CONTENT_FILE_PATTERN, CONTENT_DIR)
tfidf_vectorizer = dataset_generator.tfidf_vectorizer
word_map = dataset_generator.word_map
...
for i, case in enumerate(query):
    ...
    indx, sent_id, max_val, max_val_sent = search(case, case['candidate_documents_id'],
                                                 df, unique_tokens,word_map,tfidf_vectorizer )
